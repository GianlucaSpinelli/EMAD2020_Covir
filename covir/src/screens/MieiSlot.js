...
export default function MieiSlot({navigation}) { //non legge immagin
    return (
    
    <View>
        
        <Text style={styles.scelta}>SLOT CONFERMATI:</Text>
        <FlatList 
        scrollEnabled={true}
            ...
            data={[
                ...
                {key: '04', title: 'Domenica 27 Novembre', subtitle: '10:00 - 11:00'},
              ]}
